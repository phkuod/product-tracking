      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <header className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Production performance metrics and insights</p>
          </div>
          <button
            onClick={onBack}
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{analytics.averageCompletionTime}h</p>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {analytics.ownerPerformance.map((owner) => (
                    <tr key={owner.owner} className="border-b hover:bg-gray-50">
                      <td className="py-3 px-4 font-medium">{owner.owner}</td>
                      <td className="py-3 px-4">{owner.total}</td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="rounded-2xl">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Normal Status</h3>
          ...
          <Card className="rounded-2xl">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Overdue Items</h3>
